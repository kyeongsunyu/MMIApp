...
namespace MMI
{
    class CThreadMain
    {
        ...
        private static void Auto1Refresh()
        {
            ...
            MmiGV.frmMain.frmAuto1.lblSpongeClean.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblSpongeClean.Text = $"{MmiGV.pShMem.RMachineStatus.SpongeCleanCnt}";
            }));

            MmiGV.frmMain.frmAuto1.lblWaterJetWaterClean.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblWaterJetWaterClean.Text = $"{MmiGV.pShMem.RMachineStatus.WaterJetWaterCleanCnt}";
            }));

            MmiGV.frmMain.frmAuto1.lblWaterJetAirClean.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblWaterJetAirClean.Text = $"{MmiGV.pShMem.RMachineStatus.WaterJetAirCleanCnt}";
            }));

            MmiGV.frmMain.frmAuto1.lblSawPkFlip1AirClean.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblSawPkFlip1AirClean.Text = $"{MmiGV.pShMem.RMachineStatus.SawPkFlipY1AirClenaCnt}";
            }));

            MmiGV.frmMain.frmAuto1.lblSawPkFlip2AirClean.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblSawPkFlip2AirClean.Text = $"{MmiGV.pShMem.RMachineStatus.SawPkFlipY2AirClenaCnt}";
            }));

            MmiGV.frmMain.frmAuto1.lblFlip1AirClean.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblFlip1AirClean.Text = $"{MmiGV.pShMem.RMachineStatus.FlipY1AirCleanCnt}";
            }));

            MmiGV.frmMain.frmAuto1.lblFlip2AirClean.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblFlip2AirClean.Text = $"{MmiGV.pShMem.RMachineStatus.FlipY2AirCleanCnt}";
            }));

            MmiGV.frmMain.frmAuto1.lblPallet1AirClean.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblPallet1AirClean.Text = $"{MmiGV.pShMem.RMachineStatus.PalletY1AirCleanCnt}";
            }));

            MmiGV.frmMain.frmAuto1.lblPallet2AirClean.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblPallet2AirClean.Text = $"{MmiGV.pShMem.RMachineStatus.PalletY2AirCleanCnt}";
            }));

            MmiGV.frmMain.frmAuto1.lblGoodTray1InCnt.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblGoodTray1InCnt.Text = $"{MmiGV.pShMem.GetDM(117)}";
            }));

            MmiGV.frmMain.frmAuto1.lblGoodTray2InCnt.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblGoodTray2InCnt.Text = $"{MmiGV.pShMem.GetDM(118)}";
            }));

            MmiGV.frmMain.frmAuto1.lblReworkCount.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblReworkTrayInCnt.Text = $"{MmiGV.pShMem.GetDM(119)}";
            }));

            MmiGV.frmMain.frmAuto1.lblNGCount.Invoke(new Action(() =>
            {
                MmiGV.frmMain.frmAuto1.lblNGTrayInCnt.Text = $"{MmiGV.pShMem.GetDM(120)}";
            }));
